...
class Canto_Settings
{
    ...
    {
        $settings_link = '<a href="options-general.php?page=' . $this->parent->_token . '_settings">' . __(
            'Settings',
            'canto'
        ) . '</a>';
    ...
    {
        error_log(wp_json_encode($this->base));
        if (is_array($this->settings)) {
            ...
            foreach ($this->settings as $section => $data) {
                ...
                foreach ($data['fields'] as $field) {
                    ...
                    // Add field to page
                    @add_settings_field(
                        $field['id'], $field['label'], array($this->parent->admin, 'display_field'),
    ...
    public function settings_page()
    {
        ...
        $api_domains = array(
            ...
            'au.canto.com' => 'bb66a08e40a44591b50fa654c9ac1538',
        ...
        if (isset($_REQUEST['token']) && isset($_REQUEST['domain'])) :
            ...
            if (str_contains($domain, ".au.canto.com")) {
                $domain = str_replace(".au.canto.com", "", $domain);
            }
        ...
        <script type="text/javascript">
            jQuery('#app_api').change(function (e) {
                ...
                } else if(app_api == "au.canto.com") {
                    endpoint = endpoint.replace(/app_api\%3D(.+?)&/, 'app_api%3D' + "canto.au" + '&');
                } else {
